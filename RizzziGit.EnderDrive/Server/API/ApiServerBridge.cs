...
public sealed partial class SocketIoBridge(ApiServer server)
    : Service2<ApiServerBridgeContext>("Socket.IO Bridge", server)
{
    protected override Task<ApiServerBridgeContext> OnStart(CancellationToken cancellationToken)
    {
    ...
    protected override async Task OnStop(ApiServerBridgeContext context, Exception? exception)
    {
