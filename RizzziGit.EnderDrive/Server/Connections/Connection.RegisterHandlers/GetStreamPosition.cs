...
{
    private sealed record class GetStreamRequest
    {
        [BsonElement("streamId")]
        public required ObjectId StreamId;
    }

    private sealed record class GetStreamResponse
    {
        [BsonElement("position")]
        public required long Position;
    }

    private RequestHandler<GetStreamRequest, GetStreamResponse> GetPosition =>
